  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src="https://voaxktqgbljtsattacbn.supabase.co/storage/v1/object/sign/aayush-hospital/Header-Bar-Images/Skin-pages-image/drynes-treatment.jpg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJhYXl1c2gtaG9zcGl0YWwvSGVhZGVyLUJhci1JbWFnZXMvU2tpbi1wYWdlcy1pbWFnZS9kcnluZXMtdHJlYXRtZW50LmpwZyIsImlhdCI6MTc0MzYyMjEzOSwiZXhwIjoxOTAxMzAyMTM5fQ.gf5qsUG6FXvMgzuWq-XoAvsYR-8b2SgfCOfxYamZC-8"
          alt="Dryness Treatment"
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-center px-4">
        ...
        >
          ...
          >
            Deep Nourishment with Advanced Dryness Treatments
          </motion.h1>
        </motion.div>
      </div>
    </div>
...
const features = [
  {
    ...
    description: "State-of-the-art skin hydration equipment and facilities",
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            className="space-y-6"
          >
            <h2 className="text-3xl font-bold text-black">Advanced Dryness Solutions for Glowing Skin</h2>
            <div className="space-y-4 text-black">
              <p className="leading-relaxed">
                At Aayush Child & Skin Hospital, we recognize that dry, dehydrated skin can lead to premature ageing, 
                irritation, and discomfort. Factors like climate changes, pollution, excessive sun exposure, and lifestyle 
                habits can strip the skin of its essential moisture, leaving it feeling rough, tight, and dull. Our 
                internationally recognized advanced dryness treatments are designed to hydrate, protect, and intensely 
                moisturize your skin, restoring its softness, elasticity, and youthful glow.
              </p>

              <h3 className="text-xl font-semibold mt-6 mb-3">Our Hydration & Protection Solutions</h3>
              <ul className="list-disc pl-6 space-y-2 mb-6">
                <li><span className="font-semibold">Intense Moisturization Therapy</span> – Medical-grade hydration treatments that penetrate deep into the skin, ensuring long-lasting nourishment and moisture retention.</li>
                <li><span className="font-semibold">Sun Protection & Barrier Repair</span> – Strengthens the skin's natural barrier with dermatologist-approved formulations, shielding against UV damage, pollutants, and environmental stressors.</li>
                <li><span className="font-semibold">Nourishing Hydration Boost</span> – Utilizes advanced hydration technology, including hyaluronic acid infusions and deep-penetrating serums, to instantly replenish moisture.</li>
                <li><span className="font-semibold">Customized Hydrating Treatments</span> – A tailored approach using global-standard skincare protocols to address different skin types and hydration needs.</li>
                <li><span className="font-semibold">Skin Repair & Regeneration</span> – Clinical treatments like biorevitalization, mesotherapy, and collagen-boosting therapies to restore smoothness and elasticity.</li>
                <li><span className="font-semibold">Soft, Supple & Radiant Skin</span> – Scientifically backed hydration techniques that lock in moisture, preventing premature fine lines and roughness.</li>
              </ul>

              <p className="leading-relaxed">
                At Aayush Child & Skin Hospital, we blend science with skincare using cutting-edge dermatological 
                treatments and premium hydration solutions. Our internationally accredited skin experts ensure that 
                your skin stays deeply nourished, resilient, and youthful with treatments that go beyond just surface 
                hydration.
              </p>
              
              <p className="leading-relaxed mt-4">
                ✨ Experience world-class skin hydration and protection for a radiant, dewy glow that lasts!
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="rounded-2xl overflow-hidden shadow-xl">
              <img
                src="https://voaxktqgbljtsattacbn.supabase.co/storage/v1/object/sign/aayush-hospital/Header-Bar-Images/Skin-pages-image/dryness-page-image.jpg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJhYXl1c2gtaG9zcGl0YWwvSGVhZGVyLUJhci1JbWFnZXMvU2tpbi1wYWdlcy1pbWFnZS9kcnluZXNzLXBhZ2UtaW1hZ2UuanBnIiwiaWF0IjoxNzQzNjIyNjQ3LCJleHAiOjE5MDEzMDI2NDd9.lTKrj7IIn-9uQP7AIpkymoeNNXEW4wp9rSHLZAiJHfM"
                alt="Dryness Treatment"
            ...
            >
              <img
                src="https://voaxktqgbljtsattacbn.supabase.co/storage/v1/object/sign/aayush-hospital/Header-Bar-Images/Skin-pages-image/dryness-page.jpg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJhYXl1c2gtaG9zcGl0YWwvSGVhZGVyLUJhci1JbWFnZXMvU2tpbi1wYWdlcy1pbWFnZS9kcnluZXNzLXBhZ2UuanBnIiwiaWF0IjoxNzQzNjIzMDAxLCJleHAiOjE5MDEzMDMwMDF9.GGBPd4N0JlVbUi3_7n3EMACRoxeiXvH9634IwD1eGlE"
                alt="Skin Hydration Results"
                className="w-full h-full object-cover transform hover:scale-105 transition-transform duration-700"
              />
            </motion.div>
          </motion.div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <p className="text-base md:text-[16px] text-[#1b1a1b]">
              Meet our expert dermatologist who brings years of experience in treating dry skin conditions.
            </p>
          </motion.div>
    ...
    <section className="py-16 bg-gradient-to-r from-purple-600 to-indigo-600 relative overflow-hidden">
      ...
      >
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          >
            Schedule a consultation with our skin hydration specialists today
          </motion.p>
          <motion.button
