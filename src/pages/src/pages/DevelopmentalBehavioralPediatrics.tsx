  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src="https://voaxktqgbljtsattacbn.supabase.co/storage/v1/object/sign/aayush-hospital/Header-Bar-Images/Mom-dady-child.jpg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJhYXl1c2gtaG9zcGl0YWwvSGVhZGVyLUJhci1JbWFnZXMvTW9tLWRhZHktY2hpbGQuanBnIiwiaWF0IjoxNzQzNDAyODk5LCJleHAiOjE5MDEwODI4OTl9.8QCt3OO9qZ8RIvTbqQM1En3kDyqsER59j3K-n2xulY4"
          alt="Developmental & Behavioral Pediatrics"
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-center px-4">
        ...
        >
          ...
          >
            Supporting Every Child's Unique Development Journey
          </motion.h1>
        </motion.div>
      </div>
    </div>
...
const features = [
  {
    ...
    description: "State-of-the-art assessment and intervention tools",
  ...
  },
  {
    ...
    title: "24/7 Support",
    description: "Continuous guidance and emergency assistance",
  ...
  },
  {
    ...
    description: "Comprehensive development and behavioral support",
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            className="space-y-6"
          >
            <h2 className="text-3xl font-bold text-black">Developmental & Behavioral Pediatrics</h2>
            <div className="space-y-4 text-black">
              <p className="leading-relaxed">
                Every child is unique, and at Aayush Child & Skin Hospital, we are dedicated to helping them reach their 
                full potential. Our Developmental and Behavioral Pediatrics Department offers expert, compassionate care 
                for children facing developmental and behavioral challenges. With a personalized and holistic approach, 
                we guide families in understanding, supporting, and empowering their children to thrive.
              </p>

              <h3 className="text-xl font-semibold mt-6 mb-3">Comprehensive Care for Every Stage of Development</h3>
              <p className="leading-relaxed">
                Our experienced pediatric specialists provide tailored evaluations, therapies, and interventions to 
                support children's growth and well-being. We offer:
              </p>
              <ul className="list-disc pl-6 space-y-2 mb-6">
                <li>Prenatal Consultations – Early guidance for expecting parents</li>
                <li>Infant Development Monitoring – Ensuring timely growth milestones</li>
                <li>Assessment & Diagnosis – Identifying disabilities, motor challenges, and learning disorders</li>
                <li>Support for Behavioral Challenges – Managing ADHD, anxiety, and conduct disorders</li>
                <li>Therapy for Autism Spectrum Disorder (ASD) – Personalized treatment plans to foster social and cognitive skills</li>
                <li>Feeding & Sleep Solutions – Addressing eating difficulties, sleep disorders, and toilet training challenges</li>
                <li>Crisis Intervention & Parent Guidance – Helping families navigate difficult situations with expert support</li>
                <li>Professional Development & Training – Offering ASD-specific training and technical assistance for caregivers and educators</li>
              </ul>

              <h3 className="text-xl font-semibold mt-6 mb-3">Specialized Care for a Wide Range of Conditions</h3>
              <p className="leading-relaxed">
                Our team is equipped to diagnose and treat various developmental and behavioral conditions, including:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Motor, Speech & Cognitive Delays – Helping children overcome difficulties in movement, language, and learning</li>
                <li>Learning Disorders – Supporting children with dyslexia, math difficulties, and writing challenges</li>
                <li>Developmental Disabilities – Managing conditions such as cerebral palsy, autism, and sensory impairments</li>
                <li>Behavioral & Emotional Disorders – Addressing hyperactivity, anxiety, depression, and oppositional behaviors</li>
                <li>Chronic Illness & Developmental Challenges – Providing expert care for children with epilepsy, asthma, diabetes, and genetic disorders</li>
                <li>Regulatory Disorders – Assisting with feeding issues, sleep disturbances, bedwetting, and toilet training difficulties</li>
              </ul>

              <h3 className="text-xl font-semibold mt-6 mb-3">Empowering Families, Enriching Lives</h3>
              <p className="leading-relaxed">
                At Aayush Child & Skin Hospital, we believe in early intervention, compassionate care, and family-centered 
                support. Our mission is to help children overcome challenges, build confidence, and achieve their best 
                possible outcomes.
              </p>
              <p className="leading-relaxed mt-4">
                Together, we nurture strengths, celebrate progress, and create brighter futures.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="rounded-2xl overflow-hidden shadow-xl">
              <img
                src="https://voaxktqgbljtsattacbn.supabase.co/storage/v1/object/sign/aayush-hospital/Header-Bar-Images/Children-with-parents.jpg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJhYXl1c2gtaG9zcGl0YWwvSGVhZGVyLUJhci1JbWFnZXMvQ2hpbGRyZW4td2l0aC1wYXJlbnRzLmpwZyIsImlhdCI6MTc0MzQwNTE0MCwiZXhwIjoxOTAxMDg1MTQwfQ.W6lFYWmwBndA1scd5uYzOw1_EHNpvzQrHFyMFK5Tio8"
                alt="Developmental & Behavioral Care"
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <p className="text-base md:text-[16px] text-[#1b1a1b]">
              Meet our expert developmental pediatrician who brings years of experience in child development and behavior.
            </p>
          </motion.div>
          ...
          >
            <div className="p-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-base text-gray-700 mb-4">Senior Consultant in Developmental & Behavioral Pediatrics</p>
    ...
    <section className="py-16 bg-gradient-to-r from-purple-600 to-indigo-600 relative overflow-hidden">
      ...
      >
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          >
            Schedule a consultation with our developmental specialists today
          </motion.p>
          <motion.button
...
const DevelopmentalBehavioralPediatrics = () => {
  React.useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
...
export default DevelopmentalBehavioralPediatrics;