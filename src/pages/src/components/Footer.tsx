...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#fdf6ff] print:hidden">
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          <div>
            <div className="flex items-center mb-4">
              <h3 className="font-['Montserrat'] text-base md:text-2xl font-extrabold tracking-wider text-[#685392]">
                AAYUSH
              </h3>
              <div className="mx-1 md:mx-2 h-6 md:h-12 w-0.5 bg-[#685392]/70 rounded-full"></div>
              <div className="flex flex-col">
                <span className="font-['Montserrat'] text-sm md:text-lg font-extrabold text-[#7e3a93] tracking-wide">
                  Child & Skin
                </span>
          ...
          <div>
            <h4 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-[#7969a5]">Quick Links</h4>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1 md:space-y-2">
              <h4 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-[#7969a5]">Skin Care</h4>
              <ul className="space-y-1 md:space-y-2 max-h-48 overflow-y-auto scrollbar-hide">
                {skinCareServices.slice(0, 7).map((service, index) => (
                  <li key={index}>
                    <Link 
                      to={service.path} 
                      className="text-black/90 hover:text-black transition duration-300"
            ...
            <div className="space-y-1 md:space-y-2">
              <h4 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-[#7969a5]">Child Care</h4>
              <ul className="space-y-1 md:space-y-2 max-h-48 overflow-y-auto scrollbar-hide">
                {childCareServices.slice(0, 7).map((service, index) => (
                  <li key={index}>
                    <Link 
                      to={service.path} 
                      className="text-black/90 hover:text-black transition duration-300"
          ...
          <div>
            <h4 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-[#7969a5]">Working Hours</h4>
            <ul className="space-y-1 md:space-y-2">
              <li className="text-black/90">NICU & PICU Emergency</li>
              <li className="font-semibold">24/7 Hours</li>
              <li className="text-black/90 mt-2 md:mt-4">OPD Mon-Sat</li>
              <li className="font-semibold">09:00 AM IST – 09:00 PM IST</li>             
              <li className="text-black/90 mt-2 md:mt-4">Sunday</li>
