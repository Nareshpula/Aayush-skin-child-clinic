    ...
    <div className="min-h-screen bg-white pt-24">
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        >
          ...
          >
          <img
            src="https://voaxktqgbljtsattacbn.supabase.co/storage/v1/object/sign/aayush-hospital/Header-Bar-Images/children-ear-problem-image.jpg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJhYXl1c2gtaG9zcGl0YWwvSGVhZGVyLUJhci1JbWFnZXMvY2hpbGRyZW4tZWFyLXByb2JsZW0taW1hZ2UuanBnIiwiaWF0IjoxNzQyOTg3NjYwLCJleHAiOjE5MDA2Njc2NjB9.bYRfNKdePR2bC4pLm8pJPSCcWAnjkQ9hmOsZAicE2Co"
