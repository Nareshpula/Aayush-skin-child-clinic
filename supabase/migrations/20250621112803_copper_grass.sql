/*
  # Fix Doctor Data and Create RPC Function

  1. Changes
    - Creates a new RPC function to fetch doctors from aayush schema
    - Updates doctor data with correct profile images
    - Ensures consistent data between schemas
*/
