/*
  # Fix Timezone Issues in Date Selection

  1. Changes
    - Creates a simplified function to convert between UTC and IST
    - Fixes day name calculation to properly handle timezone differences
    - Ensures correct Sunday detection in IST timezone
    - Prevents same-day appointments with proper timezone handling
*/

-- Create a simple function to convert UTC date to IST date
...
-- Create a simple function to get the day name in IST timezone
...
-- Create a simple function to check if a date is Sunday in IST timezone
...
-- Create a simple function to check if a date is today in IST timezone
