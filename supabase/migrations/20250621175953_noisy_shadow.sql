/*
  ...
  1. Changes
    ...
    - Ensures all time slots are properly included (including 3:00 PM and 9:00 PM)
...
BEGIN
  ...
  -- Check if the date is a Sunday in IST timezone
  is_sunday := EXTRACT(DOW FROM ist_date_val) = 0;
...
BEGIN
  ...
  is_sunday_ist := EXTRACT(DOW FROM ist_date) = 0;
