/*
  ...
  1. Changes
    - Creates a new simplified function for getting available slots
    - Avoids timezone complexity by using simple date comparisons
    - Ensures proper Sunday detection
    - Fixes same-day appointment validation
*/

-- Create a simple function to get available slots without timezone complexity
