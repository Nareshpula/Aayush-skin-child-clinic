/*
  # Create SMS Logs Table in Aayush Schema

  1. New Tables
    - `aayush.sms_logs` - Stores SMS sending attempts with phone number, message type, status, and response data
  
  2. Security
    - Enable RLS on the table
    - Add policies for secure access to SMS logs
...
-- Create a view in public schema for the SMS logs
CREATE OR REPLACE VIEW public.sms_logs AS
