/*
  # Fix Timezone Functions for Appointment System

  1. Changes
    - Drops existing test_ist_timezone_conversion function to avoid return type error
    - Recreates the function with the correct return type
    - Adds a test function for slot generation with IST timezone
*/
...
-- Grant execute permissions on the function
GRANT EXECUTE ON FUNCTION public.test_slot_generation_with_ist_v2(INTEGER, DATE) TO anon, authenticated, service_role;