/*
  # Create IST Timezone Functions for Appointment System

  1. New Functions
    - Creates utility functions for IST timezone handling
    - Implements proper Sunday detection in IST timezone
    - Ensures correct slot generation based on IST day of week

  2. Changes
    - Updates get_available_slots to use IST timezone
