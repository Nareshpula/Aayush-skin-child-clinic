/*
  # Fix Patient ID Generation and Edge Function Permissions

  1. Changes
    - Improves patient ID generation function with better error handling
    - Adds helper function to safely extract numeric parts from patient IDs
    - Grants necessary permissions for edge functions to work properly
*/
