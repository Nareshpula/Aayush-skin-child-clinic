/*
  ...
  1. Changes
    - Fixes Sunday detection to use IST timezone instead of UTC
    - Updates slot display to include the last slot (3:00 PM and 9:00 PM)
    - Ensures all time logic respects IST consistently
    - Adds debug functions to verify timezone conversion
*/
...
BEGIN
  ...
  is_sunday_ist := EXTRACT(DOW FROM (p_date AT TIME ZONE 'UTC' AT TIME ZONE 'Asia/Kolkata')) = 0;
