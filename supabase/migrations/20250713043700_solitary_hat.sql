/*
  ...
  1. Changes
    - Creates a simple function to get available slots without timezone complexity
    - Adds utility functions for simple date checks and formatting
    - Fixes the day name display for selected dates
*/
