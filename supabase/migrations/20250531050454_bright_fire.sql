/*
  # Fix patient ID generation and add edge function permissions

  1. Changes
    - Improve patient ID generation with better error handling
    - Add helper function to safely extract numeric parts from patient IDs
    - Fix regex pattern matching for more reliable ID generation
*/
